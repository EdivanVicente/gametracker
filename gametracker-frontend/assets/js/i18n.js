...
const GT_DICT = {
  'pt-BR': {
    ...
    'detail.datesFromSessionsHint': 'Essas datas são calculadas a partir do histórico de jogadas abaixo — use "Jogar novamente" ou o botão de editar de cada jogada pra corrigi-las.',
  ...
  'en': {
    ...
    'detail.datesFromSessionsHint': 'These dates are calculated from the playthrough history below — use "Play again" or each entry\'s edit button to fix them.',
  ...
  'es': {
    ...
    'detail.datesFromSessionsHint': 'Estas fechas se calculan a partir del historial de partidas de abajo — usa "Jugar de nuevo" o el botón de editar de cada partida para corregirlas.',
