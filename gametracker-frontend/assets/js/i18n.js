...
const GT_DICT = {
  'pt-BR': {
    ...
    'auth.registerSuccessTitle': 'Quase lá! Confirme seu e-mail',
    'auth.registerSuccessText': 'Enviamos um link de confirmação para o e-mail abaixo. Verifique sua caixa de entrada e também a pasta de spam / lixo eletrônico — às vezes ele cai lá.',
    'auth.goToLogin': 'Ir para o login',

    // --- Toolbar / filtros (dashboard) ---
    'toolbar.searchPlaceholder': 'Pesquise em seus jogos',
    ...
    'detail.datesFromSessionsHint': 'Editar aqui corrige a jogada mais antiga (início) ou a jogada atual (fim). Pra corrigir uma jogada específica do histórico, use o botão de editar dela mais abaixo.',
    'detail.playCountLabel': 'Vezes jogado',
    'detail.readMore': 'Ler mais',
    'detail.readLess': 'Mostrar menos',
    'detail.sortLabel': 'Ordenar por',
    'detail.sortRecent': 'Mais recentes',
    'detail.sortOldest': 'Mais antigas',
    'detail.lastPlayed': 'Última vez',
    'detail.logSession': 'Jogar novamente',
    'detail.finishSession': 'Finalizar esta jogada',
    'detail.editSession': 'Editar esta jogada',
    'detail.deleteSession': 'Excluir jogada',
    'detail.confirmDeleteSession': 'Tem certeza que quer excluir essa jogada do histórico? Essa ação não pode ser desfeita.',
    'detail.sessionDurationOptional': 'Tempo (opcional)',
    'detail.sessionError': 'Não foi possível registrar essa jogada.',
    'detail.sessionDateOrderError': 'A data de finalização não pode ser anterior à data de início.',
    'detail.hoursPlayed': 'Horas jogadas',
    'detail.hoursPlayedFormatHint': 'formato hh:mm (horas:minutos)',
    'detail.timeToBeatMain': 'Duração estimada (missão principal)',
    'detail.timeToBeat100': 'Duração estimada (100%)',
    'detail.timeToBeatHint': 'As durações estimadas vêm do HowLongToBeat e servem só como referência — por isso não são editáveis. Só "Horas jogadas" pode ser ajustado manualmente.',
    ...
    'addGame.addBtn': 'Adicionar',
    'addGame.addingBtn': 'Adicionando...',
    'addGame.startDateLabel': 'Quando você começou a jogar?',
  ...
  'en': {
    ...
    'footer.credit': 'GameTracker Pro © 2026 — built by Edivan Vicente and Gleison Torres',
    ...
    'auth.registerSuccessTitle': 'Almost there! Confirm your email',
    'auth.registerSuccessText': "We've sent a confirmation link to the email below. Check your inbox and also your spam / junk folder — it sometimes ends up there.",
    'auth.goToLogin': 'Go to login',

    'toolbar.searchPlaceholder': 'Search your games',
    ...
    'detail.datesFromSessionsHint': 'Editing here fixes the oldest playthrough (start) or the current one (finish). To fix a specific entry in the history, use its edit button below.',
    'detail.playCountLabel': 'Times played',
    'detail.readMore': 'Read more',
    'detail.readLess': 'Show less',
    'detail.sortLabel': 'Sort by',
    'detail.sortRecent': 'Most recent',
    'detail.sortOldest': 'Oldest',
    'detail.lastPlayed': 'Last played',
    'detail.logSession': 'Play again',
    'detail.finishSession': 'Finish this playthrough',
    'detail.editSession': 'Edit this playthrough',
    'detail.deleteSession': 'Delete playthrough',
    'detail.confirmDeleteSession': 'Are you sure you want to delete this playthrough from the history? This cannot be undone.',
    'detail.sessionDurationOptional': 'Time (optional)',
    'detail.sessionError': 'Could not save this playthrough.',
    'detail.sessionDateOrderError': 'The finish date cannot be earlier than the start date.',
    'detail.hoursPlayed': 'Hours played',
    'detail.hoursPlayedFormatHint': 'format hh:mm (hours:minutes)',
    'detail.timeToBeatMain': 'Estimated time (main story)',
    'detail.timeToBeat100': 'Estimated time (100%)',
    'detail.timeToBeatHint': 'Estimated durations come from HowLongToBeat and are for reference only — that\'s why they can\'t be edited. Only "Hours played" can be adjusted manually.',
    ...
    'addGame.addBtn': 'Add',
    'addGame.addingBtn': 'Adding...',
    'addGame.startDateLabel': 'When did you start playing?',
    'addGame.add': 'Add',
  ...
  'es': {
    ...
    'auth.registerSuccessTitle': '¡Ya casi! Confirma tu correo',
    'auth.registerSuccessText': 'Enviamos un enlace de confirmación al correo de abajo. Revisa tu bandeja de entrada y también la carpeta de spam / correo no deseado — a veces cae ahí.',
    'auth.goToLogin': 'Ir al login',

    'toolbar.searchPlaceholder': 'Busca tus juegos',
    'toolbar.filters': 'Filtros',
    ...
    'detail.datesFromSessionsHint': 'Editar aquí corrige la partida más antigua (inicio) o la actual (fin). Para corregir una partida específica del historial, usa su botón de editar más abajo.',
    'detail.playCountLabel': 'Veces jugado',
    'detail.readMore': 'Ler mais',
    'detail.readLess': 'Mostrar menos',
    'detail.sortLabel': 'Ordenar por',
    'detail.sortRecent': 'Más recientes',
    'detail.sortOldest': 'Más antiguas',
    'detail.lastPlayed': 'Última vez',
    'detail.logSession': 'Jugar de nuevo',
    'detail.finishSession': 'Finalizar esta partida',
    'detail.editSession': 'Editar esta partida',
    'detail.deleteSession': 'Eliminar partida',
    'detail.confirmDeleteSession': '¿Seguro que quieres eliminar esta partida del historial? Esta acción no se puede deshacer.',
    'detail.sessionDurationOptional': 'Tiempo (opcional)',
    'detail.sessionError': 'No fue posible registrar esta partida.',
    'detail.sessionDateOrderError': 'La fecha de finalización no puede ser anterior a la de inicio.',
    ...
    'detail.timeToBeatHint': 'Las duraciones estimadas vienen de HowLongToBeat y son solo de referencia — por eso no son editables. Solo "Horas jugadas" se puede ajustar manualmente.',
    ...
    'addGame.addBtn': 'Añadir',
    'addGame.addingBtn': 'Añadiendo...',
    'addGame.startDateLabel': '¿Cuándo empezaste a jugar?',
    'addGame.add': 'Añadir',
